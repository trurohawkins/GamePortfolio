const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-b8Q3cU_3.js","assets/phaser-BOgQtUoh.js","assets/index-_9qSmR-E.css"])))=>i.map(i=>d[i]);
var v=Object.defineProperty;var P=(h,e,t)=>e in h?v(h,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):h[e]=t;var s=(h,e,t)=>P(h,typeof e!="symbol"?e+"":e,t);import{_ as M}from"./index-b8Q3cU_3.js";import"./phaser-BOgQtUoh.js";class u{constructor(e,t,i=1e3,o=.25){s(this,"container");s(this,"shots",[]);s(this,"cur",0);s(this,"fade",1e4);s(this,"playing",!1);s(this,"scene");s(this,"pause",120);s(this,"curPause",0);s(this,"curShot");s(this,"nextShot");this.duration=i,this.names=[];for(let a=0;a<t;a++)this.names.push(e+a);this.scale=o}addToScene(e){this.scene=e,this.container=e.add.container(0,0),this.names.forEach((t,i)=>{const o=e.add.sprite(0,0,t);o.setAlpha(0),o.setDepth(1e3),o.setTint(8421504),this.container.add(o),this.shots.push(o)}),this.container.setScale(this.scale)}highlight(e){this.shots.forEach(t=>{e?t.setTint(16777215):t.setTint(8421504)})}crossFadeTo(e){e===this.cur||e<0||e>=this.shots.length||(this.curShot=this.shots[this.cur],this.nextShot=this.shots[e],this.scene.tweens.add({targets:this.curShot,alpha:0,duration:this.duration,onComplete:()=>{this.curShot.alpha=0}}),this.scene.tweens.add({targets:this.nextShot,alpha:1,duration:this.duration,onComplete:()=>{this.curPause=0}}),this.cur=e)}play(){this.playing=!0,this.shots[this.cur].setAlpha(1),this.curPause=0}hide(){this.playing=!1,this.scene.tweens.killTweensOf(this.curShot),this.scene.tweens.killTweensOf(this.nextShot);for(let e=0;e<this.shots.length;e++)this.shots[e].setAlpha(0)}update(){this.curPause<this.pause&&(this.curPause++,this.curPause==this.pause&&this.crossFadeTo((this.cur+1)%this.shots.length))}}function c(h){return new Promise(e=>setTimeout(e,h))}class m{constructor(e,t,i,o,a,n){s(this,"key");s(this,"title");s(this,"tech");s(this,"gameLink");s(this,"collaborators");s(this,"scale",1);this.key=e,this.title=t,this.description=i,this.tech=o,this.gameLink=a,this.collaborators=n}}class C{constructor(){s(this,"videos",[]);s(this,"shots",[]);s(this,"cur",0);s(this,"curCloud");const e="Pilot a giant mecha and rescue human survivors from space debris.<br>Play with your friends to kill aliens, blow up obstacles and save people!<br>Help the most people to WIN THE GLORY!",t=`
		...
		`,o=new m("gloryDogs","GloryDogs",e,t,"https://gamejolt.com/games/glorydogs/638631",i);o.scale=.4,this.videos.push(o),this.shots.push(new u("gd",5));const a=`
		...
		`,g=new m("stroid","Stroid",a,n,"_",l);this.videos.push(g),this.shots.push(new u("stroid",6));const r=`
		...
		`,S=new m("peepeeMadness","PeePee Madness",y,"Unity","https://trugames.itch.io/peepee-madness",f);this.videos.push(S),this.shots.push(new u("pp",4));const w=`
