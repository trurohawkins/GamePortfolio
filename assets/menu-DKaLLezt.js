const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DErVLXTr.js","assets/phaser-BOgQtUoh.js","assets/index-Cv53f7st.css"])))=>i.map(i=>d[i]);
var T=Object.defineProperty;var E=(h,t,e)=>t in h?T(h,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):h[t]=e;var i=(h,t,e)=>E(h,typeof t!="symbol"?t+"":t,e);import{_ as M}from"./index-DErVLXTr.js";import"./phaser-BOgQtUoh.js";class u{constructor(t,e,s=1e3,o=.25){i(this,"container");i(this,"shots",[]);i(this,"cur",0);i(this,"fade",1e4);i(this,"playing",!1);i(this,"scene");i(this,"pause",120);i(this,"curPause",0);i(this,"curShot");i(this,"nextShot");this.duration=s,this.names=[];for(let n=0;n<e;n++)this.names.push(t+n);this.scale=o}addToScene(t){this.scene=t,this.container=t.add.container(0,0),this.names.forEach((e,s)=>{const o=t.add.sprite(0,0,e);o.setAlpha(0),o.setDepth(1e3),o.setTint(8421504),this.container.add(o),this.shots.push(o)}),this.container.setScale(this.scale)}highlight(t){this.shots.forEach(e=>{t?e.setTint(16777215):e.setTint(8421504)})}crossFadeTo(t){t===this.cur||t<0||t>=this.shots.length||(this.curShot=this.shots[this.cur],this.nextShot=this.shots[t],this.scene.tweens.add({targets:this.curShot,alpha:0,duration:this.duration,onComplete:()=>{this.curShot.alpha=0}}),this.scene.tweens.add({targets:this.nextShot,alpha:1,duration:this.duration,onComplete:()=>{this.curPause=0}}),this.cur=t)}play(){this.playing=!0,this.shots[this.cur].setAlpha(1),this.curPause=0}hide(){this.playing=!1,this.scene.tweens.killTweensOf(this.curShot),this.scene.tweens.killTweensOf(this.nextShot);for(let t=0;t<this.shots.length;t++)this.shots[t].setAlpha(0)}update(){this.curPause<this.pause&&(this.curPause++,this.curPause==this.pause&&this.crossFadeTo((this.cur+1)%this.shots.length))}}function c(h){return new Promise(t=>setTimeout(t,h))}class m{constructor(t,e,s,o,n,a){i(this,"key");i(this,"title");i(this,"tech");i(this,"gameLink");i(this,"collaborators");i(this,"scale",1);this.key=t,this.title=e,this.description=s,this.tech=o,this.gameLink=n,this.collaborators=a}}class P{constructor(){i(this,"videos",[]);i(this,"shots",[]);i(this,"cur",0);i(this,"curCloud");const t="Pilot a giant mecha and rescue human survivors from space debris.<br>Play with your friends to kill aliens, blow up obstacles and save people!<br>Help the most people to WIN THE GLORY!",e=`
		...
		`,o=new m("gloryDogs","GloryDogs",t,e,"https://gamejolt.com/games/glorydogs/638631",s);o.scale=.4,this.videos.push(o),this.shots.push(new u("gd",5));const n=`
		...
		`,p=new m("stroid","Stroid",n,a,"_",l);this.videos.push(p),this.shots.push(new u("stroid",6));const r=`
